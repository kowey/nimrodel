...
rem Purpose:          Rebuild DATR saved image
...
%usepop%\pop\pop\pop11 +startup %%nort $popliblib/mkimage.p -subsystem datr $poplocalbin/datr.psv $usepop/pop/plog/src/prolog.p datr datr_subsystem
